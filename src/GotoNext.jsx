...
class GotoNext extends React.Component {
  ...
  return ( <div>{window.location.pathname!='/confirmation'&& <button className="btn btn-primary" style={{backgroundColor: "#86BC25",borderColor:"#86BC25"}} onClick={()=>{this.next(history)}}>Proceed</button>}</div>);
